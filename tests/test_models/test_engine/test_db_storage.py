...
class TestFileStorage(unittest.TestCase):
    ...
    def get(self, cls, id):
        ...
        retreve_state = storage.get(State, state_inst.id)
        self.assertEqual(state_inst, retreve_state)
    ...
    def count(self, cls=None):
        ...
        city_data = {"name": "Paris", "state_id": state_inst.id}
